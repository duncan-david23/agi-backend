...
import { fetchTasks, addUserTasks, sellAllTasks, updateCommission, fetchDailyTasks, loadDailyTasks} from '../controllers/userTasksController.js';
...
router.get('/load-tasks', loadDailyTasks);
